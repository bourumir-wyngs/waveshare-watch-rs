...
fn seg_h<D: DrawTarget<Color = Rgb565>>(
    d: &mut D,
    x: i32,
    y: i32,
    w: i32,
...
fn seg_v<D: DrawTarget<Color = Rgb565>>(
    d: &mut D,
    x: i32,
    y: i32,
    h: i32,
...
pub fn draw_colon<D: DrawTarget<Color = Rgb565>>(
    d: &mut D,
    x: i32,
    y: i32,
    h: i32,
...
pub fn draw_time<D: DrawTarget<Color = Rgb565>>(
    ...
    draw_digit(d, x, y, h / 10, dw, dh, t, color, bg)?;
    x += dw + gap;
    draw_digit(d, x, y, h % 10, dw, dh, t, color, bg)?;
    x += dw + gap;
    draw_colon(d, x + cw / 2 - t / 2, y, dh, t, color)?;
    x += cw + gap;
